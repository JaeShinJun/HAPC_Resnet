...
trainloader = DataLoader(trainset, collate_fn=trainset.collate_func, batch_size=50, num_workers=6)
testloader = DataLoader(testset, collate_fn=testset.collate_func, batch_size=50, num_workers=6)
submissionloader = DataLoader(subset, collate_fn=subset.collate_func, batch_size=50, num_workers=6)
...
def test():
    ...
    #         #     running_loss = 0.0
    #     print('Finish %d epoch training' %(epoch + 1))
    #     correct = 0
    #     total = 0
    #     with torch.no_grad() :
    ...
    submission_predictions =predict_submission(net, subset)
    THRESHOLD = 0.2
