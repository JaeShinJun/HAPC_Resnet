...
# trainloader = DataLoader(trainset, collate_fn=trainset.collate_func, batch_size=100, num_workers=6)
# testloader = DataLoader(testset, collate_fn=testset.collate_func, batch_size=100, num_workers=6)
