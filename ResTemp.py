...
trainloader = DataLoader(trainset, collate_fn=trainset.collate_func, batch_size=64, num_workers=6)
testloader = DataLoader(testset, collate_fn=testset.collate_func, batch_size=64, num_workers=6)
submissionloader = DataLoader(subset, collate_fn=subset.collate_func, batch_size=64, num_workers=6)
